...
export const TOWER_DEFINITIONS: Record<TowerType, TowerDefinition> = {
  ...
  [TowerType.BARRICADE]: {
    ...
    cost: 60,
    description: '주변 적을 감속시키고 소량의 데미지를 주는 방어 구조물',
    color: '#A78BFA',
    icon: '🧱',
    blockHp: 200,
  },
  ...
  // ── Legendary Towers (Random-only) ────────────────────────

  [TowerType.METEOR]: {
    type: TowerType.METEOR,
    name: 'Meteor Tower',
    nameKr: '운석탑',
    element: 'fire',
    attackType: 'area',
    ...
    cost: 300,
    description: '하늘에서 운석을 소환하여 광범위 피해를 입힙니다',
    color: '#FF4500',
    icon: '☄️',
    areaRadius: 2.0,
  },
  ...
  [TowerType.VOID]: {
    ...
    cost: 350,
    description: '블랙홀로 적을 끌어당기며 지속 피해를 줍니다',
    color: '#4B0082',
    icon: '🌀',
    areaRadius: 1.5,
  },
  ...
  [TowerType.PHOENIX]: {
    ...
    cost: 400,
    description: '불사조가 주기적으로 화염 폭발을 일으킵니다',
    color: '#FF6347',
    icon: '🔥',
    areaRadius: 2.0,
    dotDamage: 10,
  ...
  [TowerType.CHRONO]: {
    ...
    cost: 350,
    description: '시간을 왜곡하여 범위 내 모든 적을 극도로 감속시킵니다',
    color: '#00CED1',
    icon: '⏳',
    slowPercent: 60,
  },
  ...
  [TowerType.DIVINE]: {
    ...
    cost: 500,
    description: '범위 내 모든 아군 타워의 공격력과 공격속도를 강화합니다',
    color: '#FFD700',
    icon: '✨',
  },
};
